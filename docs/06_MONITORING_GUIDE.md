> **시리즈**: 대용량 시스템 스터디 가이드
> - **이전**: [Phase 5 - 데이터베이스 최적화](./05_DATABASE_GUIDE.md)
> - **현재**: Phase 6 - 모니터링 & 옵저버빌리티
...
이 문서는 마켓플레이스 프로젝트를 통해 애플리케이션 모니터링과 옵저버빌리티를 학습합니다.
...
────────────────────────────────────────
"트래픽 받을 준비 됐나?"
- 실패 시: 서비스에서 제외 (재시작 안 함)
- 용도: 시작 중, 의존성 연결 중, 과부하 시
