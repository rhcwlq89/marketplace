> **시리즈**: 대용량 시스템 스터디 가이드
> - **이전**: [Phase 4 - Resilience 패턴](./04_RESILIENCE_GUIDE.md)
> - **현재**: Phase 5 - 데이터베이스 최적화
> - **다음**: [Phase 6 - 모니터링](./06_MONITORING_GUIDE.md)
...
이 문서는 마켓플레이스 프로젝트를 통해 데이터베이스 최적화 기법을 학습합니다.
