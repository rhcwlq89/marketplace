> **시리즈**: 대용량 시스템 스터디 가이드
> - **이전**: [Phase 3 - 이벤트 드리븐](./03_EVENT_DRIVEN_GUIDE.md)
> - **현재**: Phase 4 - Resilience 패턴
> - **다음**: [Phase 5 - 데이터베이스 최적화](./05_DATABASE_GUIDE.md)
> - **전체 목차**: [STUDY_GUIDE.md](./STUDY_GUIDE.md)

---

# Resilience 패턴 스터디 가이드

이 문서는 마켓플레이스 프로젝트를 통해 장애 대응 패턴(Resilience Patterns)을 학습합니다.
